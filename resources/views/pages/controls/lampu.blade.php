                    ...
                    <div class="form-group">
                        ...
                        <div id="mode" class="btn-group btn-group-toggle btn-group-sm mx-4" data-toggle="buttons">
                            <label class="btn btn-outline-primary active">
                                <input type="radio" name="mode" id="otomatis" @if($getLastLampStatus->mode == '0') selected @endif value="0" autocomplete="off"
                                    checked>
                                Otomatis
                            </label>
                            <label class="btn btn-outline-primary">
                                <input type="radio" name="mode" id="manual" @if($getLastLampStatus->mode == '1') selected @endif  value="1" autocomplete="off">
                                Manual
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="row" id="show">
                            ...
                            <div class="row justify-content-center align-items-center">
                                <div class="col-9">
                                    <input type="range" class="custom-range w-100" min="25" max="35"
                                        value="30" name="suhu" id="suhu-mati"
                                        oninput="document.getElementById('label-suhu-mati').innerHTML = this.value">
                                </div>
                                <div class="col-3">
                                    <span class="small mb-1 text-center" id="label-suhu-mati">30</span>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="row justify-content-center align-items-center">
                                <div class="col-9">
                                    <input type="range" class="custom-range w-100" min="25" max="35"
                                        value="30" name="suhu" id="suhu-nyala"
                                        oninput="document.getElementById('label-suhu-nyala').innerHTML = this.value">
                                </div>
                                <div class="col-3">
                                    <span class="small mb-1 text-center" id="label-suhu-nyala">30</span>
                                    <span class="small mb-1">°C</span>
                                </div>
                            </div>
                        </div>
                ...
                switch (n) {
                    case '1':
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="medium mb-1 text-danger"><strong>23</strong></div>
                        </div>
                        <div class="col-md-4">
                            <div class="small mb-1">Batas jam untuk lampu menyala saat ini</div>
                            <div class="medium mb-1 text-success"><strong>23</strong></div>
                        </div>
                        `)
                        $('#show').html(`
                        <div class="form-group col-md-4">
